...
template.innerHTML = `
  <div class="product-img position-relative overflow-hidden">
    ...
    <div class="text-center py-4">
      ...
      >
        <slot name="price-product">Preço do produto</slot>
        <slot name="old-price-product">Preço Antigo</slot>
      </div>
      <div
...
class ProductCard extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const promotionBar = shadowRoot.querySelector('.promotion-bar');
      const img = shadowRoot.querySelector('.card-img-top');
      const title = shadowRoot.querySelector('.card-title');
      const price = shadowRoot.querySelector('.card-text');
      const buyLink = shadowRoot.querySelector('.btn-cards');
  ...
  // Função para criar o carrossel do Custom Element
  function createCustomElementCarousel() {
    const bookContainer = document.getElementById("bookContainerCustomElement");
    const groupedBooks = chunkArray(livrosOfertas, 4);
    ...
    groupedBooks.forEach((group, index) => {
      ...
      group.forEach(book => {
        ...
        productCard.setAttribute('data-book', JSON.stringify(book));
        cardDeck.appendChild(productCard);
      });
